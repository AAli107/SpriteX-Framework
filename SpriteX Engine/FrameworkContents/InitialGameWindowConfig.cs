...
namespace SpriteX_Framework.FrameworkContents
{
    public static class InitialGameWindowConfig
    {
        ...
        public static readonly Vector2i ClientSize = new (1280, 720); // Default Window Resolution when not in fullscreen
        ...
        public static readonly WindowState WindowState = WindowState.Normal; // Decides window state (can be used to set fullscreen) 
        ...
        public static readonly bool showDebugHitbox = false; // Controls whether to show all GameObjects' collider components
